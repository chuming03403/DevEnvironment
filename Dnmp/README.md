...
7. 内置**完整PHP扩展安装**命令
8. 默认支持`pdo_mysql`、`redis`、`xdebug`、`swoole`、`solr`等常用热门扩展，根据环境灵活配置
...
2. `clone`项目：
    ```
    $ git clone https://github.com/chuming03403/DevEnvironment.git
    ```
...
两个站点使用同一PHP代码：`./wwwroot/localhost/index.php`。
